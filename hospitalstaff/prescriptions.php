      ...
      <div class="modal-content">
        ...
        <form id="updateprescriptionForm">
          <div class="modal-body">
            ...
            <div class="form-group mb-3">
              <input type="hidden" id="updateapprovedby" value="<?= $_SESSION['auth_user']['staff_id']; ?>"
                name="updateapprovedby" class="form-control" placeholder="approvedby">
            </div>
          </div>
          <div class="modal-footer">
            <input type="hidden" name="action" id="action" value="editPrescription" />
...
$(document).ready(function() {
  ...
  $("#prescriptionTable").on('click', '.updateBtn', function() {
    var prescription_id = $(this).attr("id");
    var action = 'getPrescriptionbyID';
  ...
  $("#prescriptionTable").on('click', '.viewBtn', function() {
    var prescription_id = $(this).attr("id");
    var action = 'getPrescriptionforView';
