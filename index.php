            ...
            <div class="row">
              <div class="col-md-7 col-lg-6 ">
                <div class="detail-box">
                  ...
                  <p>
                    The best choice for your medical needs.
                  </p>
                  <div class="btn-box">
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="box ">
          ...
          <div class="detail-box">
            ...
            <p>
              Your orders delivered within 24hrs
            </p>
          </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="box ">
          ...
          <div class="detail-box">
            <h5>
              Shop with Prescriptions
            </h5>
            <p>
              Got a prescription? We got you covered
            </p>
          </div>
        </div>
      </div>
      <div class="col-md-4">
        <div class="box ">
          ...
          <div class="detail-box">
            ...
            <p>
              We provide verified high quality products
            </p>
          </div>
        </div>
      </div>
...
<section class="product_section layout_padding">
  <div class="container">
    ...
    <div class="row" id="test2">
      ...
      <!-- Getting products -->
      <?php
$getProducts = "SELECT * FROM `tbl_product` LIMIT 8";
$getProducts_execute = mysqli_query($connection, $getProducts);
// $result = mysqli_fetch_array($getProducts_execute);
      ...
      <div class="col-md-4">
        <div class="full">
          ...
          <div class="information_f">
            <p><strong>ADDRESS:</strong> Sample Towers, Unknown Location</p>
            <p><strong>TELEPHONE:</strong> +254701234567</p>
            <p><strong>EMAIL:</strong> myPharma@gmail.com</p>
          </div>
        </div>
      </div>
      <div class="col-md-8">
              ...
              <div class="col-md-6">
                <div class="widget_menu">
                  ...
                  <ul>
                    ...
                    <li><a href="uploadprescription.php">Add prescription</a></li>
                  </ul>
                </div>
              </div>
...
<!-- footer end -->
<div class="cpy_">
  <p class="mx-auto">© 2022 All Rights Reserved By myPharma<br>
  </p>
</div>
<?php
